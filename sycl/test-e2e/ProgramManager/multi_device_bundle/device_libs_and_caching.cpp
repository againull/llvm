// Test checks urProgramCreateWithBinaryExp functionality which is supported
// only Level Zero backend at the moment.
...
int main() {
  ...
  // kernel to each device.
  {
    ...
    // CHECK-AOT-TRACE: urProgramCreateWithBinaryExp
