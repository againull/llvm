...
/// @brief Optional callback for querying subscriber's requested detail level per stream.
...
/// Called by framework during stream initialization to compute effective detail level.
/// @param stream_name Stream name being queried.
